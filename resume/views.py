...
def generate_resume(request):
    if request.method == "POST":
        ...
        Extract the user's name and contact details from the existing resume.
        Ensure that the contact information is up-to-date and well-formatted.
        Experience:

        Analyze the job description to emphasize relevant experiences from the existing resume.
        Adjust and organize the work experience section to highlight key achievements and responsibilities relevant to the job role.
        Education:

        Ensure the education section aligns with the job requirements specified in the job description.
        Emphasize relevant degrees, certifications, or courses that match the job role.
        Skills:

        Match and adjust skills listed in the resume to fit the skills mentioned in the job description.
        Include additional skills relevant to the job role extracted from the job description.
        Interests:

        Extract and format interests or hobbies that might be relevant or add value to the job role.
        Style and Formatting:

        Create a visually appealing layout with proper formatting, including sections such as contact information, summary, experience, education, skills, and interests.
        Ensure the resume follows ATS guidelines and uses standard fonts, bullet points, and section headers.
        Finalization:

        Generate the adjusted resume text with proper headings and organized sections.
        Ensure the resulting resume is well-structured, easy to read, and showcases the user's qualifications effectively.
        Avoid citing things like this: "Note: This resume has been optimized to align with the requirements of a Software Engineer position, specifically in Python development and test automation in a Linux environment."
        """
